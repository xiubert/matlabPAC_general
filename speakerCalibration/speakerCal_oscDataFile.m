...
%default values
oscDataDir = 'D:\Data\sutter2P\Jinbo\calibration\calibration_JC_20260612';
...
idTc = readcell(fullfile(lFolder,lFile),'sheet','folderLegend');
stimLabels = string(idTc(2:end,2));
...
savePath = 'C:\Rig\speakerCalibration';
save(fullfile(savePath,['calibrationOutput_oscopeFile_'...
    micType 'mic_' ...
    num2str(Gcal) 'gain_' ...
    num2str(datestr(now,'yyyymmdd')) '_JC' '.mat']),'calibration_oscopeFile');
